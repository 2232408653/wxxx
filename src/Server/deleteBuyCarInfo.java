 ...
 */
/**
 * Servlet implementation class deleteBuyCarInfo
 */
@WebServlet("/deleteBuyCarInfo")
public class deleteBuyCarInfo extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		b.deleteByUserNameAndProductID(userName, id);
